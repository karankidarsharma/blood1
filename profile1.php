 ...
 <nav class="navbar navbar-inverse nav1">
  <div class="container-fluid">
    ...
    <ul class="nav navbar-nav navbar-right">
      <li class="active"><a>Hi, <?php echo $n ?></a></li>
...
<p>NOTE: You will be logged out automatically after update</p>
</br>
...
<form id="form1" onsubmit="return validateForm()"  action="update.php" method="post" class="form-horizontal" onsubmit="javascript:return validate ();">
