...
<form action="delete1.php" method="post" class="form-horizontal" >
  <h1 style="text-align:center;"> <strong>Enter</strong></h1>
</br>
</br>
  
    &nbsp&nbsp  <label>*Email:</label>
    <input type="email" name="text" value="">
  </br>
   </br>
<button type="submit" class="btn btn-danger btn-lg"  name="submit2">Delete&nbsp<span class="glyphicon glyphicon-send"></span></button>
</form>
</div>
</div>
  </body>
