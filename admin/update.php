...
<button type="submit" class="btn btn-danger btn-lg"  name="submit2">Show!&nbsp<span class="glyphicon glyphicon-send"></span></button>
</form>
</div>
</div>
  </body>
