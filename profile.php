...
if( x== ""){
  ...
  document.getElementById("sError").innerHTML = "Please Enter Valid Username";
  return false;
} else{
...
if( y == ""){
  document.getElementById("fError").innerHTML = "Please Enter Valid Password"
  return false;
} else{
...
<div id="loader1"><h1 style=" font-size:50px; text-align: center;"> </br><b> Hello! user!</b><img src="image/2.gif"></br> </h1></div>
    ...
    <div class="navbar-header ">
     ...
     <ul class="nav navbar-nav">
      <li class="btn-default"><a href="index.php">Home</a></li>
       <li class="active"><a href="profile.php">Edit your profile</a></li>
...
<form id="form1" onsubmit="return validateForm();" action="profile1.php" method="post" class="form-horizontal" >
  <h1 style="text-align:center;"> <strong>User Login</strong></h1>
</br>
</br>
  
   &nbsp&nbsp  <label >*Username:</label>
    <input type="email" id="text" name="text" value="root@gmail.com">
  <p id="sError"></p>
   </br>
...
<p></p>&nbsp&nbsp<button type="submit"  class="btn btn-danger btn-lg"  name="submit2">Login!&nbsp<span class="glyphicon glyphicon-user"></span></button>
<a href="register.php" class="btn btn-danger btn-lg">Register&nbsp<span class="glyphicon glyphicon-send"></span></a>
</form>
